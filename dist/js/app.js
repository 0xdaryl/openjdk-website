...
},{"./_defined":17,"./_fails":24,"./_hide":31,"./_redefine":63,"./_regexp-exec":65,"./_wks":87,"./es6.regexp.exec":99}],26:[function(require,module,exports){
'use strict';
...
},{"./_create-property":15,"./_ctx":16,"./_export":22,"./_is-array-iter":36,"./_iter-call":40,"./_iter-detect":43,"./_to-length":80,"./_to-object":81,"./core.get-iterator-method":88}],92:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":2,"./_iter-define":42,"./_iter-step":44,"./_iterators":45,"./_to-iobject":79}],93:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var aFunction = require('./_a-function');
var toObject = require('./_to-object');
...
},{"./_a-function":1,"./_export":22,"./_fails":24,"./_strict-method":73,"./_to-object":81}],94:[function(require,module,exports){
var dP = require('./_object-dp').f;
...
},{"./_descriptors":18,"./_object-dp":50}],95:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./_export');

$export($export.S + $export.F, 'Object', { assign: require('./_object-assign') });

},{"./_export":22,"./_object-assign":48}],96:[function(require,module,exports){
...
},{"./_object-keys":58,"./_object-sap":60,"./_to-object":81}],97:[function(require,module,exports){
'use strict';
...
},{"./_classof":10,"./_redefine":63,"./_wks":87}],98:[function(require,module,exports){
var global = require('./_global');
var inheritIfRequired = require('./_inherit-if-required');
var dP = require('./_object-dp').f;
var gOPN = require('./_object-gopn').f;
...
},{"./_descriptors":18,"./_fails":24,"./_flags":26,"./_global":29,"./_inherit-if-required":34,"./_is-regexp":39,"./_object-dp":50,"./_object-gopn":54,"./_redefine":63,"./_set-species":68,"./_wks":87}],99:[function(require,module,exports){
'use strict';
var regexpExec = require('./_regexp-exec');
require('./_export')({
  target: 'RegExp',
...
},{"./_export":22,"./_regexp-exec":65}],100:[function(require,module,exports){
'use strict';
...
},{"./_advance-string-index":3,"./_an-object":5,"./_fix-re-wks":25,"./_regexp-exec-abstract":64,"./_to-length":80}],101:[function(require,module,exports){
'use strict';
...
},{"./_advance-string-index":3,"./_an-object":5,"./_fix-re-wks":25,"./_regexp-exec-abstract":64,"./_to-integer":78,"./_to-length":80,"./_to-object":81}],102:[function(require,module,exports){
'use strict';
...
},{"./_an-object":5,"./_fix-re-wks":25,"./_regexp-exec-abstract":64,"./_same-value":66}],103:[function(require,module,exports){
'use strict';
...
},{"./_advance-string-index":3,"./_an-object":5,"./_fails":24,"./_fix-re-wks":25,"./_is-regexp":39,"./_regexp-exec":65,"./_regexp-exec-abstract":64,"./_species-constructor":72,"./_to-length":80}],104:[function(require,module,exports){
'use strict';
...
},{"./_collection":13,"./_collection-strong":12,"./_validate-collection":84}],105:[function(require,module,exports){
...
},{"./_export":22,"./_fails-is-regexp":23,"./_string-context":75,"./_to-length":80}],106:[function(require,module,exports){
...
},{"./_export":22,"./_fails-is-regexp":23,"./_string-context":75}],107:[function(require,module,exports){
'use strict';
var $at = require('./_string-at')(true);
...
},{"./_iter-define":42,"./_string-at":74}],108:[function(require,module,exports){
'use strict';
...
},{"./_string-html":76}],109:[function(require,module,exports){
...
},{"./_export":22,"./_fails-is-regexp":23,"./_string-context":75,"./_to-length":80}],110:[function(require,module,exports){
'use strict';
...
},{"./_wks-define":85}],113:[function(require,module,exports){
...
},{"./_global":29,"./_hide":31,"./_iterators":45,"./_object-keys":58,"./_redefine":63,"./_wks":87,"./es6.array.iterator":92}],114:[function(require,module,exports){
"use strict";
...
module.exports.load = function () {
  setRadioSelectors();
  loadAssetInfo(variant, jvmVariant, 'releases', undefined, 'adoptopenjdk', buildArchiveHTML, function () {
...
},{"./common":115,"core-js/modules/es6.array.from":91,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.string.includes":106,"core-js/modules/es6.string.iterator":107,"core-js/modules/es6.string.link":108,"core-js/modules/es7.array.includes":111}],115:[function(require,module,exports){
(function (global){
"use strict";
...
module.exports.loadAssetInfo = function (variant, openjdkImp, releaseType, release, vendor, handleResponse, errorHandler) {
  if (variant === 'amber') {
...
},{"../json/config":123,"core-js/modules/es6.array.find":90,"core-js/modules/es6.array.find-index":89,"core-js/modules/es6.array.from":91,"core-js/modules/es6.array.iterator":92,"core-js/modules/es6.array.sort":93,"core-js/modules/es6.object.assign":95,"core-js/modules/es6.object.keys":96,"core-js/modules/es6.object.to-string":97,"core-js/modules/es6.regexp.constructor":98,"core-js/modules/es6.regexp.match":100,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.regexp.search":102,"core-js/modules/es6.regexp.split":103,"core-js/modules/es6.string.ends-with":105,"core-js/modules/es6.string.includes":106,"core-js/modules/es6.string.iterator":107,"core-js/modules/es6.symbol":110,"core-js/modules/es7.array.includes":111,"core-js/modules/es7.symbol.async-iterator":112,"core-js/modules/web.dom.iterable":113}],116:[function(require,module,exports){
"use strict";
...
},{"./archive":114,"./common":115,"./index":117,"./installation":118,"./nightly":119,"./releases":120,"./testimonials":121,"./upstream":122,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.regexp.split":103}],117:[function(require,module,exports){
"use strict";
...
},{"./common":115,"core-js/modules/es6.array.iterator":92,"core-js/modules/es6.function.name":94,"core-js/modules/es6.object.keys":96,"core-js/modules/es6.object.to-string":97,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.string.includes":106,"core-js/modules/es6.string.link":108,"core-js/modules/es7.array.includes":111,"core-js/modules/web.dom.iterable":113}],118:[function(require,module,exports){
"use strict";
...
module.exports.load = function () {
  setRadioSelectors();
  loadAssetInfo(variant, jvmVariant, 'releases', 'latest', 'adoptopenjdk', buildInstallationHTML, function () {
...
},{"./common":115,"core-js/modules/es6.array.from":91,"core-js/modules/es6.function.name":94,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.string.includes":106,"core-js/modules/es6.string.iterator":107,"core-js/modules/es6.string.link":108,"core-js/modules/es7.array.includes":111}],119:[function(require,module,exports){
"use strict";
...
function populateNightly() {
  ...
  loadAssetInfo(variant, jvmVariant, 'nightly', undefined, 'adoptopenjdk', handleResponse, function () {
...
},{"./common":115,"core-js/modules/es6.array.find":90,"core-js/modules/es6.function.name":94,"core-js/modules/es6.regexp.constructor":98,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.regexp.split":103,"core-js/modules/es6.string.includes":106,"core-js/modules/es6.string.link":108,"core-js/modules/es7.array.includes":111}],120:[function(require,module,exports){
(function (global){
"use strict";
...
global.populateFilters = function (filter) {
  ...
  try {
    for (var _iterator = releaseTable[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  if (filter == 'all' || filter == 'os') {
    ...
    try {
      for (var _iterator2 = new Set(OSES)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var os = _step2.value;
  ...
  if (filter == 'all' || filter == 'arch') {
    ...
    try {
      for (var _iterator3 = new Set(ARCHES)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function filterTable(string, type, string1) {
  ...
  try {
    for (var _iterator4 = tables[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
},{"./common":115,"core-js/modules/es6.array.find":90,"core-js/modules/es6.array.iterator":92,"core-js/modules/es6.array.sort":93,"core-js/modules/es6.object.to-string":97,"core-js/modules/es6.regexp.replace":101,"core-js/modules/es6.regexp.split":103,"core-js/modules/es6.set":104,"core-js/modules/es6.string.includes":106,"core-js/modules/es6.string.iterator":107,"core-js/modules/es6.string.link":108,"core-js/modules/es6.string.starts-with":109,"core-js/modules/es6.symbol":110,"core-js/modules/es7.array.includes":111,"core-js/modules/es7.symbol.async-iterator":112,"core-js/modules/web.dom.iterable":113}],121:[function(require,module,exports){
"use strict";
...
try {
  for (var _iterator = gaButtons[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
module.exports.load = function () {
  ...
  setRadioSelectors();
  loadAssetInfo(variant, jvmVariant, ga, undefined, 'openjdk', buildUpstreamHTML, function () {
    // if there are no releases (beyond the latest one)...
    // report an error, remove the loading dots
    loading.innerHTML = '';
    errorContainer.innerHTML = "<p>There are no archived releases yet for ".concat(variant, " on the ").concat(jvmVariant, " JVM.\n      See the <a href='./releases.html?variant=").concat(variant, "&jvmVariant=").concat(jvmVariant, "'>Latest release</a> page.</p>");
...
global.populateFilters = function (filter) {
  ...
  try {
    for (var _iterator2 = releaseTable[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  if (filter == 'all' || filter == 'os') {
    ...
    try {
      for (var _iterator3 = new Set(OSES)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var os = _step3.value;
        var option = document.createElement('option');
        option.text = os;
        option.value = os;
  ...
  if (filter == 'all' || filter == 'arch') {
    ...
    try {
      for (var _iterator4 = new Set(ARCHES)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
function filterTable(string, type, string1) {
  ...
  try {
    for (var _iterator5 = tables[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
module.exports={
  ...
  "platforms": [
    ...
    },
    {
      ...
      "supported_version": "2008r2 or later"
    },
    {
